#!/bin/bash
#SBATCH -J dorado_fetal_w7
#SBATCH -n 32
#SBATCH -N 1
#SBATCH -t 120:00:00
#SBATCH -A csens2024-3-2
#SBATCH -o dorado_fetal_w7_%j.out
#SBATCH -e dorado_fetal_w7_%j.err
#SBATCH -p sens-gpu
...
POD5_DIR="/path/to/rawdata/backup/op_065/rawdata/op_065_009/pod5_pass/"
REFERENCE_GENOME="/path/to/genome/backup/hg38.fa"
BAM_OUTPUT="/path/to/results/backup/op_065/1_mapping/hg38/MN10_Control_w7_Rep1_ontDNA_fetal_human_basecalls_5mC_5hmC_hg38.bam"
